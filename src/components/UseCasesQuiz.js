...
const AllQuestions = {
    question1: { 
        question: "Use Cases are for functional and non-functional reuirements?",
        choices: {
            choice1: {
                content: "True",
                correct: true,
    ...
    question2: { 
        question: "Use cases can show the actors who need to be connected for a specific requirement?",
        choices: {
            choice1: {
                content: "True",
                correct: true,
    ...
    question3: { 
        question: "Use cases are complex and detailed?",
        choices: {
            choice1: {
                content: "True",
                correct: false,
    ...
    question4: { 
        question: "A Use Case for a customer ordering food from a waiter has how many actors?",
        choices: {
            choice1: {
                content: "One for the customer ordering food.",
                correct: false,
            },
            choice2: {
                content: "One for the customer ordering food. Two for the waiter writing the order.",
                correct: true,
            },
            choice3: {
                content: "One for the customer ordering food. Two for the waiter writing the order. Three for the chef making the order.",
                correct: false,
            },
        } 
    } 
...
class UseCasesQuiz extends Component {
